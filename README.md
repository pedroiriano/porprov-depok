...
- Seluruh rute aktif Public dan Admin masih memiliki baseline Techwind `dist` yang telah diaudit. Governance v5 mempertahankan Techwind sebagai otoritas Public dan Cuba sebagai otoritas Admin. Implementasi Cuba clean-room v5.6 aktif lokal dan telah mencakup seluruh route utama, tabel/form/modal canonical, RBAC, draft lokal, revision history, serta acceptance 390/768/1440 px light/dark. Source/aset vendor tidak masuk repository GitHub publik; production tetap memakai baseline rollback sampai deployment disetujui.
