...
- Public Web Tahap 13.1–13.5 memiliki shell Techwind clean-room dengan navigasi Beranda, Cabor, Venue, Jadwal, Klasemen, Jelajah, dan Berita. Beranda memuat Hero dinamis, pengantar, Maskot Toca-Toci, ringkasan pertandingan/medali faktual, Venue, Berita Depok fail-safe, dan Panduan Kota. Kandidat perubahan Berita berikutnya membatasi Beranda, arsip, detail, dan sitemap pada feed resmi bertag `PorprovJabar2026`; status runtime production mengikuti deployment terverifikasi, bukan keberadaan source lokal. Cabor memiliki pencarian/kategori, Venue memiliki pencarian/filter kesiapan/peta, dan Jelajah membaca kategori aktif secara dinamis. Detail Venue tetap memprioritaskan satu rekomendasi yang dipin Admin. Finalisasi lokal 8 September 2026 meluluskan 44 kombinasi visual pada 11 rute, 390/1440 px, serta tema terang/gelap; lint/build, smoke HTTPS, header keamanan, PWA, ZAP pasif, dependency audit, SBOM, dan CVE image juga lulus. Git delivery telah digabung melalui PR #30 pada commit `7c373207042da10fad93b89da7be97b06dbb64f3`.
...
- Remediasi VA 15 September 2026 menempatkan kolektor Umami di belakang validator API Gateway. Payload dibatasi berdasarkan Origin, website, hostname, tipe event, ukuran, URL/referrer, dan judul; input traversal seperti `title=/collect` ditolak sebelum mencapai dependency internal tanpa menonaktifkan analitik yang sah. Bukti dan batas status deployment dicatat di `docs/security/VA_2026-09-15_ZAP_HIGH_REMEDIATION.md`.
...
Prometheus `3.13.3-porprov.1`, serta dependency patched
