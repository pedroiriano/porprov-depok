...
- Remediasi VA 15 September 2026 menempatkan kolektor Umami di belakang validator API Gateway. Production aktif pada commit `ecbbb270` sejak 21 September 2026: event valid `200`, input traversal `title=/collect` `400`, 19 layanan berjalan, backup delapan database/Media ber-checksum tersedia. ZAP pasif tidak menemukan High; satu alert Medium SRI pada preload gambar same-origin ditriase terpisah tanpa menghapus konten. Bukti dan rollback dicatat di `docs/security/VA_2026-09-15_ZAP_HIGH_REMEDIATION.md`.
