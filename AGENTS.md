...
- Exception dependency hanya boleh memakai advisory ID, package, project, alasan, mitigasi, dan tanggal kedaluwarsa yang eksplisit serta disetujui pengguna; CI wajib tetap gagal untuk temuan lain dan setelah expiry. Exception aktif `image-size` untuk dua aplikasi mobile berakhir 7 Oktober 2026 dan mengikuti `docs/security/NPM_AUDIT_EXCEPTION_IMAGE_SIZE_2026-09-07.md`.
